...
#We can change it back to SVM if we would like but the performance is extremely slow, i think random forest will be our best bet for the non-neural network model
